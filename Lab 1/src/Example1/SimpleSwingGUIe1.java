...
*/
	...
	frame = new JFrame("Simple Swing GUI - E1");
        ...
        // Create a keyboard shortcut(mnemonic): Pressing ALT-B will act as a mouse click on the button.	
...
//      frame.add(pane);   
	...
	frame.pack();
	//set the size of the frame forcibly. Packing the frame will not have any effect in this case.
