...
public class CalculatorViewController extends JPanel {
    ...
    public CalculatorViewController() {  
	    ...
	    // Creates a panel that holds the + and - button
	    JPanel rightKeypad = new JPanel(new GridLayout(2, 1, 0, 3));
	    ...
	    // Creates a panel that holds the * and / button
	    JPanel leftKeypad = new JPanel(new GridLayout(2, 1, 0, 3));
	    ...
	    // Sets multiply and divide preferred sizes
	    multiply.setPreferredSize(new Dimension(50,192));
	    divide.setPreferredSize(new Dimension(50,192));

	    // Sets both multiplication and division button to left side of keypad
	   // leftKeypad.add(multiply, BorderLayout.PAGE_START);
	   // leftKeypad.add(divide, BorderLayout.PAGE_END);
	    leftKeypad.setBackground(Color.BLACK);
	    leftKeypad.setBorder(BorderFactory.createMatteBorder(0, 0, 0, 5, Color.BLACK));
	    
	    // Sets plus and minus button sizes
	    plus.setPreferredSize(new Dimension(48,45));
	    minus.setPreferredSize(new Dimension(48,45));
	    
	    // Adds both addition and subtraction buttons to the right side of keypad
	   // rightKeypad.add(plus, BorderLayout.PAGE_START);
	    rightKeypad.add(equal, BorderLayout.WEST);
	    rightKeypad.setBackground(Color.BLACK);
	    rightKeypad.setBorder(BorderFactory.createMatteBorder(0, 5, 0, 0, Color.BLACK));
	    
	    clear.setPreferredSize(new Dimension(44, 44));
	    equal.setPreferredSize(new Dimension(44, 44));
	    
	    // Adds clear and equal to keypad
	    keypad.add(clear, BorderLayout.WEST);
	    keypad.add(equal, BorderLayout.EAST);
 
	    // Adds the components of the keypad to the main panel
	    main.add(leftKeypad, BorderLayout.LINE_START);
	    keypad.add(arithmetic, BorderLayout.CENTER);
	    main.add(rightKeypad, BorderLayout.LINE_END);
	    main.add(keypad);
